<div id="modalCrearCliente" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg border border-[#4553921a] w-full max-w-md p-6 relative">
        <h2 class="text-lg font-bold text-[#455392] mb-4">➕ Crear Cliente</h2>
        ...
        <form action="{{ route('empresa.clientes.store', $empresa->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" class="w-full border border-[#D1C4E9] rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-[#455392]" required>
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-[#444478]">Correo electrónico</label>
                <input type="email" name="email" class="w-full border border-[#D1C4E9] rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-[#455392]">
            </div>

            <div class="mb-4">
                <label class="block text-sm font-medium text-[#444478]">Teléfono</label>
                <input type="text" name="telefono" class="w-full border border-[#D1C4E9] rounded px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-[#455392]">
            </div>
